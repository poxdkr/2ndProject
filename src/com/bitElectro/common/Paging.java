...
public class Paging {
	...
	public void setTotalPage() {
		totalPage = totalRecord / numPerPage; //총페이지 =  총 게시글 수 / 한 페이지에 보여질 게시글 수 
		if (totalRecord % numPerPage > 0) totalPage++; // 10 % 3 = 0이 아닐 경우 페이지를 하나 더 추가 (총 4페이지가 됨) 
	}
